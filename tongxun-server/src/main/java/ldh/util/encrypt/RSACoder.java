...
public class RSACoder  {    
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {    
        // 解密由base64编码的私钥    
        byte[] keyBytes = BASE64.decrypt(privateKey);    
    ...
    public static byte[] decryptStringByPrivateKey(String data) throws Exception {
    	byte[] tt = BASE64.decrypt(data);
    	byte[] bytes = decryptByPrivateKey(tt, getPrivateKey(KEYS));
    	return bytes;
    }
...
//    }    
    ...
    public static byte[] encryptByPublicKey(byte[] data) throws Exception {
    	return encryptByPublicKey(data, getPublicKey(KEYS));
    }
    /**   
     * 
     * 加密<br>   
    ...
    public static byte[] encryptByPrivateKey(byte[] data) throws Exception {
    	return encryptByPrivateKey(data, getPrivateKey(KEYS));
    }
